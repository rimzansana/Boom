/****************************************************************************
** Meta object code from reading C++ file 'attacker.h'
**
...
#include "../Tank/attacker.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'attacker.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Attacker_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Attacker_t qt_meta_stringdata_Attacker = {
    {
QT_MOC_LITERAL(0, 0, 8), // "Attacker"
QT_MOC_LITERAL(1, 9, 12), // "moveAttacker"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "Attacker\0moveAttacker\0"
};
...
void Attacker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Attacker *_t = static_cast<Attacker *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->moveAttacker(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Attacker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Attacker.data,
      qt_meta_data_Attacker,  qt_static_metacall, nullptr, nullptr}
};
